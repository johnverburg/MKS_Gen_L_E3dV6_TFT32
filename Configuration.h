...
#define PRINTER_NAME "DaniBanani"  // Change this to whatever you wish, or leave it as it is.
...
#define CHANGE_E0_DIRECTION     // If your Extruder0 loads in the wrong direction (if you load filament and it instead unloads) enable this.
//#define CHANGE_E1_DIRECTION     // If your Extruder1 loads in the wrong direction (if you load filament and it instead unloads) enable this.
